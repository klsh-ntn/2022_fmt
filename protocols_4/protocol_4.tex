...
% table 1
\protocol{1.1}{$\rho$}{$\delta$}{Сергей Ламзин}{Леша Смолянинов, Миша Трапезников}

% table 2
\protocol{1.2}{$\eta$}{$\iota$}{Ваня Адо}{Боря Демешев, Роберт Гринштейн}

% table 3
\protocol{2.1}{$\beta$}{$\alpha$}{Тая Житина}{Владимир Мезенцев, Вадим Тимергалеев}

% table 4
\protocol{2.2}{$\varepsilon$}{$\chi$}{Ваня Трофимов}{Егор Адиятов, Андрей Мордасевич}

% table 5
\protocol{3.1}{$\theta$}{$\kappa$}{Полина Смирнова}{Артем Майдуров, Влада Синицына}

% table 6
\protocol{3.2}{$\lambda$}{$\nu$}{Марк Прокушкин}{Ян Шапиро}

% table 7
\protocol{ВК}{$\mu$}{$o$}{Антон Шейкин}{Настя Андреева, Даня Снегур}

% table 8
\protocol{беседка мед-1}{$\sigma$}{$\tau$}{Лев Каминский}{Максим Федянов}

% table 9 
\protocol{беседка 1-2}{$\gamma$}{$\xi$}{Вика Луковская?}{Игорь Скрипко}

% table 10
\protocol{беседка 2-3}{$\psi$}{$\omega$}{Лиза Моисеева}{Михаил Красков}

% table 11
\protocol{столовая}{$\pi$}{$\varphi$}{Миша Шишацкий}{Ярослав Федулов, Боря Дураков?}
}
