...
\newcommand{\blockofjudges}{
% table 1
\protocol{1.1}{$\delta$}{$\chi$}{Антон Шейкин}{Леша Смолянинов, Миша Трапезников} % ф

% table 2
\protocol{1.2}{$\alpha$}{$\eta$}{Боря Демешев}{Полина Смирнова, Роберт Гринштейн}  % ф 
% table 3
\protocol{2.1}{$\beta$}{$\iota$}{Ваня Адо}{Вадим Тимергалеев, Ирина Поликарпова} % ф

% table 4
\protocol{2.2}{$o$}{$\tau$}{Ваня Трофимов}{Егор Адиятов, Андрей Мордасевич} % ф

% table 5
\protocol{3.1}{$\theta$}{$\lambda$}{Ваня Карлов}{Артем Майдуров, Игорь Скрипко} % ф 

% table 6
\protocol{3.2}{$\rho$}{$\sigma$}{Вика Луковская}{Миша Красков, Настя Андреева} % ф = Миша

% table 7
\protocol{ВК}{$\kappa$}{$\nu$}{Тая Житина}{Даня Снегур, Влада Синицына} % ф = Даня

% table 8
\protocol{беседка мед-1}{$\varphi$}{$\psi$}{Лев Каминский}{Максим Федянов, } % ф = Макс 

% table 9 
\protocol{беседка 1-2}{$\xi$}{$\omega$}{Марк Прокушкин}{Лиза Моисеева} % ф = Марк

% table 10
\protocol{беседка 2-3}{$\mu$}{$\pi$}{Владимир Мезенцев}{Ян Шапиро} % ф = Мезенцев

% table 11
\protocol{столовая}{$\gamma$}{$\varepsilon$}{Миша Шишацкий}{Ярослав Федулов} % ф = Миша
}
