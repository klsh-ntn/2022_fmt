...
\newcommand{\blockofjudges}{
% table 1
\protocol{1.2}{$\delta$}{$\chi$}{Полина Смирнова}{Ваня Адо, Серёжа Ламзин, Боря Демешев, Роб Гринштейн} % ф = Ваня
% Роберт Гринштейн

% table 2
\protocol{2.2}{$\beta$}{$\tau$}{Миша Трапезников}{Антон Шейкин, Вика Луковская, Вадим Тимергалеев, Андрей Мордасевич}  % ф = 
}
% Андрей Мордасевич
